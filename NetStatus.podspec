...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Tony" => "c78420@yahoo.com.tw" }
  # Or just: spec.author    = "Tony"
  # spec.authors            = { "Tony" => "c78420@yahoo.com.tw" }
  # spec.social_media_url   = "https://twitter.com/Tony"
  ...
  spec.source       = { :git => "https://github.com/c78420/NetStatus.git", :tag => "#{spec.version}" }
